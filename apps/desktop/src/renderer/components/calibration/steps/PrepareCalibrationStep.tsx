...
function PositionIcon({ position }: { position: 0 | 1 | 2 | 3 | 4 | 5 }) {
  const icons = [
    ...
    // 4: Nose Up - diagonal arrow up-right
    ...
    // 5: Inverted (Top Down) - arrow pointing down
