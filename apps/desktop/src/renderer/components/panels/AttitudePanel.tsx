    ...
    <PanelContainer className="flex flex-col items-center justify-center">
      ...
      <div className="flex gap-6 mt-4 text-sm">
        <div className="text-center">
          <div className="text-content-secondary text-xs mb-0.5">横滚</div>
          <div className="font-mono text-content">{formatNumber(throttled.roll, 1)}°</div>
        </div>
        <div className="text-center">
          <div className="text-content-secondary text-xs mb-0.5">俯仰</div>
          <div className="font-mono text-content">{formatNumber(throttled.pitch, 1)}°</div>
        </div>
        <div className="text-center">
          <div className="text-content-secondary text-xs mb-0.5">偏航</div>
