...
export const ARDUPILOT_MODELS: Record<ArduPilotVehicleType, Array<{ value: string; label: string }>> = {
  copter: [
    { value: 'quad', label: '四旋翼(默认)' },
    { value: '+', label: '四旋翼十字型 (+)' },
    { value: 'hexa', label: '六旋翼' },
    { value: 'octa', label: '八旋翼' },
    { value: 'tri', label: '三旋翼' },
    { value: 'coax', label: '共轴直升机' },
    { value: 'heli', label: '直升机' },
    { value: 'singlecopter', label: '单旋翼机' },
  ],
  plane: [
    { value: 'plane', label: '固定翼(默认)' },
    { value: 'quadplane', label: '垂起固定翼' },
    { value: 'firefly', label: 'FireFly6' },
    { value: 'plane-vtail', label: 'V 尾固定翼' },
    { value: 'plane-dspoilers', label: '带扰流板固定翼' },
  ],
  rover: [
    { value: 'rover', label: '漫游车(默认)' },
    { value: 'rover-skid', label: '滑差转向' },
    { value: 'boat', label: '船' },
    { value: 'sailboat', label: '帆船' },
    { value: 'balancebot', label: '平衡机器人' },
  ],
  sub: [
    { value: 'vectored', label: '矢量推进(默认)' },
    { value: 'vectored_6dof', label: '矢量推进 6DOF' },
  ],
};
